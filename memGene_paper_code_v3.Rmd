...
jpeg(paste0(here::here(), "/output/Figure1.jpg"), width=5.5, height=12, units="in", res=300)
par(mfrow=c(4,2), mai=c(0.3,0.3,0.5,0.2))
#par(mfrow=c(4,2), mai=c(0.1,0.1,0.2,0.05))
...
g <- arrangeGrob(Plots[[1]], Plots[[2]], Plots[[3]], ncol = 3, nrow = 1) #generates g
 ...
 ggsave(file=paste0(here::here(), "/output/Figure2.jpg"), g, width=8, height=3)
...
jpeg(paste0(here::here(), "/output/Figure3.jpg"), width=8, height=3, units="in", res=300)
...
ggsave(file=paste0(here::here(), "/output/Figure4.jpg"), g, width=8.5, height=9)
```
