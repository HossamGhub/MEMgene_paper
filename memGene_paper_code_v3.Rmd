...
box()
mgMap(coord, Res.mem[[1]]$vectorsMEM[, Res.mem[[1]]$Positive$selectedMEM[1]], 
      add.plot=TRUE)
mtext(bquote("a)  Island model: Adj." ~ R^2 == 
               .((round(max(0, Res.mem[[1]]$analysis$RsqAdj),2)))), 
      side=3, adj=0, line=1)
plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[1]]$vectorsMEM[, Res.mem[[1]]$Positive$selectedMEM[2]], 
      add.plot=TRUE)


plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[2]]$vectorsMEM[, Res.mem[[2]]$Positive$selectedMEM[1]], 
      add.plot=TRUE)
mtext(bquote("b)  Isolation by distance: Adj." ~ R^2 == 
               .((round(Res.mem[[2]]$analysis$RsqAdj,2)))), 
      side=3, adj=0, line=1)
plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[2]]$vectorsMEM[, Res.mem[[2]]$Positive$selectedMEM[2]], 
      add.plot=TRUE)


plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[3]]$vectorsMEM[, Res.mem[[3]]$Positive$selectedMEM[1]], 
      add.plot=TRUE)
mtext(bquote("c)  One refugium: Adj." ~ R^2 == 
               .((round(Res.mem[[3]]$analysis$RsqAdj,2)))), 
      side=3, adj=0, line=1)
plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[3]]$vectorsMEM[, Res.mem[[3]]$Positive$selectedMEM[2]], 
      add.plot=TRUE)


plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[4]]$vectorsMEM[, Res.mem[[4]]$Positive$selectedMEM[1]], 
      add.plot=TRUE)
mtext(bquote("d)  Two refugia: Adj." ~ R^2 == 
               .((round(Res.mem[[4]]$analysis$RsqAdj,2)))), 
      side=3, adj=0, line=1)
plot(coord[,1], coord[,2], type="n", xlab="", ylab="", axes=FALSE)
box()
mgMap(coord, Res.mem[[4]]$vectorsMEM[, Res.mem[[4]]$Positive$selectedMEM[2]], 
      add.plot=TRUE)
