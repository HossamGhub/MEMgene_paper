...
Effect of the number of individuals sampled:
...
Effect sizes (Cohen's d for paired t-test): this is interesting!
...
Drop IM model: effect size (Cohen's d for paired t-test)
...
Repeat paired t-tests without IM model:
