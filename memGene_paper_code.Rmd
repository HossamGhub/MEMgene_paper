...
D11.a.s<- ggplot(D11.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    ggtitle("IBD") + xlab("Comparison") + ylab(expression(bold('Fst adjusted R'^2))) +
    theme(axis.text = element_text(size = 12),
...
D22.a.s<- ggplot(D22.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    ggtitle("1R") + xlab("Comparison") + ylab(expression(bold('Fst adjusted R'^2))) +
    theme(axis.text = element_text(size = 12),
          plot.title = element_text(size=16, face="bold", hjust = 0.5),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
...
D33.a.s<- ggplot(D33.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    ggtitle("2R") + xlab("Comparison") + ylab(expression(bold('Fst adjusted R'^2))) +
    theme(axis.text = element_text(size = 12),
          plot.title = element_text(size=16, face="bold", hjust = 0.5),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
...
D44.a.s<- ggplot(D44.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
   xlab("Comparison") + ylab("Fst Mora's I") +
    theme(axis.text = element_text(size = 12),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
          )
...
D77.a.s<- ggplot(D77.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
   xlab("Comparison") + ylab("Fst scaled Mora's I") +
    theme(axis.text = element_text(size = 12),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
          )
...
D1.a.s<- ggplot(D1.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    ggtitle("IBD") + xlab("Comparison") + ylab(expression(bold('Dch adjusted R'^2))) +
    theme(axis.text = element_text(size = 12),
          plot.title = element_text(size=16, face="bold", hjust = 0.5),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
...
D2.a.s<- ggplot(D2.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    ggtitle("1R") + xlab("Comparison") + ylab(expression(bold('Dch adjusted R'^2))) +
    theme(axis.text = element_text(size = 12),
          plot.title = element_text(size=16, face="bold", hjust = 0.5),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
...
D3.a.s<- ggplot(D3.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
    ggtitle("2R") + xlab("Comparison") + ylab(expression(bold('Dch adjusted R'^2))) +
    theme(axis.text = element_text(size = 12),
          plot.title = element_text(size=16, face="bold", hjust = 0.5),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
...
D4.a.s<- ggplot(D4.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
   xlab("Comparison") + ylab("Dch Mora's I") +
    theme(axis.text = element_text(size = 12),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
          )
...
D7.a.s<- ggplot(D7.s, aes(x = Comparison, y = Mean)) + ylim(0,1.0) +
   ...
   geom_point(shape = 1, size  = 2) +
   theme_bw() + theme (panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
   xlab("Comparison") + ylab("Dch scaled Mora's I") +
    theme(axis.text = element_text(size = 12),
          axis.title.x = element_text(size=12, face="bold"),
          axis.title.y = element_text(size=12, face="bold")
          )
